...
export MANPATH=/usr/local/opt/gnu-sed/libexec/gnuman:$MANPATH # man page for gnu sed

# export docker host address
export DOCKER_TLS_VERIFY="1"
export DOCKER_HOST="tcp://192.168.99.100:2376"
export DOCKER_CERT_PATH="$HOME/.docker/machine/machines/docker-server"
export DOCKER_MACHINE_NAME="docker-server"

# Java home
export JAVA_HOME="$(/usr/libexec/java_home)"
# Jena Fuseki runtime area
export FUSEKI_BASE=/tmp/fuseki
